...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess, allUsers, schoolName }) => (
  <div style={{
    ...
    <div className="glass-panel" style={{ width: '100%', maxWidth: '440px', padding: '2.25rem 2rem', background: '#1c1c1e', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 20px 40px rgba(0,0,0,0.6)' }}>
